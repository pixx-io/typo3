...
namespace Pixxio\PixxioExtension\Tests\Unit\Backend;
...
class AutoLoginTest extends UnitTestCase
{
    ...
    public function testPostMessageFormat(): void
    {
        ...
        $this->assertEquals('pixxio-plugin-sdk', $expectedMessage['sender']);
        $this->assertEquals('loginSuccess', $expectedMessage['method']);
